...
function neststandard() {
  return (
    <div>
        <div className='grid grid-cols-1 md:grid-cols-[60%_40%] bg-gradient-to-r from-[#FAFDFF] to-[#F5F5FF] pl-16 container'>
            <div className="flex flex-col justify-center">
                ...
                <div>
                <button className='bg-black text-white px-8 py-2 font-dmsans text-[16.2px]'>Contact Now</button>
                </div>

            </div>
            <div className='mb-4 py-10  font-dmsans text-[13.5px] pr-6 divide-y-2'>
