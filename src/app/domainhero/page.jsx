...
function Domain() {
  ...
  return (
    <div className="container lg:w-[80%] h-[70%] w-6/6">
      <div className="bg-[url('/backgrounds.png')] bg-cover flex items-center justify-center rounded-md relative h-[400px] lg:h-[500px]">
        <div className="xl:w-2/5 mx-auto my-8 absolute  left-[8%]">
          ...
          <p className="font-dmsans text-lg text-white">
            Kickstart your online journey with Nepal's No.1 Domain Registrar.
            Register your domain at the best prices and pair it with our
            top-rated web hosting plans to create a professional online
            presence.
          </p>
        </div>
      ...
      <div>
        <div className="bg-white md:px-6 py-6 rounded-lg shadow-lg md:w-5/6 mx-auto relative top-[-80px]">
          <div className="flex flex-wrap px-4 py-2 sm:mx-6 mt-4">
            <div className="md:px-8 rounded-lg py-2 flex justify-between border sm:w-4/5 mx-auto font-dmsans outline-none">
              <input
                type="text"
            ...
            <button className="mx-auto   px-10 py-2 bg-black font-dmsans font-bold text-lg text-white">
              Search
            </button>
          </div>
          <div className="flex justify-center flex-wrap font-dmsans font-semibold text-[#393939] text-xl gap-10 mt-3">
            {arr.map((data, index) => (
              <div
                key={index}
          ...
          <div className="mt-4 flex justify-center font-dmsans text-sm">
            ...
            <h1 className="font-medium">
              ...
              <div className="font-bold underline inline">
