    ...
    <div className='container'>
        <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-14 mt-7'>
            <div className='max-w-96 p-4 mt-6'>
                ...
                <h1 className='font-montserrat text-black text-4xl tracking-[2%]] py-2 font-[900]  '>Your <span className='text-blue-800'>Website,<br/> </span >Moved with <span className='text-blue-800'> Care !</span></h1>
