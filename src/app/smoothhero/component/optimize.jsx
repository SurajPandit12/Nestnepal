        ...
        <p className="font-poppins font-medium text-lg text-center text-[#393939] ">Easy domain setup, WHOIS protection, and free website migration</p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2  items-center mb-12 '>
             ...
             <h1 className='text-4xl  font-poppins tracking-[1%] pb-8 max-w-lg font-[700] py-6'> Seamless and Efficient Migration Process
              ...
              <div className="mt-10 ml-4">
                    <button className='border-2 border-black px-10 py-2 font-dmsans'>See Plans & Pricing</button>
               </div>
             </div>
             <div className="hidden lg:flex">
              <img className="h-[580.14px] w-[697.95px]" src="laptopman.png"></img>
             </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 items-center '>
              ...
              <div className="ml-10 font-dmsans">
                <p className="font-dmsans text-xl font- text-[#1818B3] font-[500]">Performance-Driven Hosting</p>
                  <h1 className="text-4xl  font-poppins py-6 font-[700] max-w-[500px]">Seamless and Efficient Migration Process</h1>
                  <p className="text-sm font-dmsans font-light max-w-xl">At Nest Nepal, we employ the latest technology in hosting to ensure your website runs smoothly. With seamless migration, fast page loads, and great responsiveness across all devices, your website is up and reliable, ensuring top-notch performance at all times.</p>
